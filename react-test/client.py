...
def retrieve_data():
    ...
    depth = round(random.uniform(0.1, 10.0), 2)  # Replace with your logic to get the depth
    ...
    return score, depth, pressure, cycle, elapsed_time

while True:
    score, depth, pressure, cycle, elapsed_time = retrieve_data()
    data = {
        'score': score,
        'depth': depth,
        'pressure': pressure,
    ...
    time.sleep(0.5)  # Delay for 0.4 second